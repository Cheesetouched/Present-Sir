...
public class PhoneNumber extends AppCompatActivity implements  View.OnClickListener{
    ...
    private static final String REQUEST_OTP = "http://presentsir.esy.es/requestotp.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        HashMap<String, String> regnum = session.getMobileDetails();

        mobilenumber = regnum.get(SessionManagement.MOB_NUM);
        ...
        submit.setBackgroundColor(Color.parseColor("#99FF5C5C"));
        ...
        pten.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                ...
                if(pten.getText().toString().length()==1) {
                    ...
                    submit.setBackgroundColor(Color.parseColor("#FF5C5C"));
    ...
    private void match() {
        ...
        String loginmobile = first+second+third+fourth+fifth+sixth+seventh+eighth+ninth+tenth;

        if (loginmobile.equals(mobilenumber)) {
            ...
            Toast.makeText(this, "Login And Input Mobile Number Must Be Same!", Toast.LENGTH_LONG).show();
